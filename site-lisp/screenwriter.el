...
;; $Id: screenwriter.el,v 1.1 2004/08/27 19:24:03 vls Exp $
...
;; http://www.nongnu.org/screenwriter/files/screenwriter.el
...
(defconst screenwriter-version "1.5.0"
...
(define-key-after
  screenwriter-mode-map
  [menu-bar screenwriter]
  (cons "Screenwriter" (make-sparse-keymap "screenwriter"))
  'tools )
(define-key
  screenwriter-mode-map
  [menu-bar screenwriter trans]
  '("Transition" . screenwriter-transition))
(define-key
  screenwriter-mode-map
  [menu-bar screenwriter dialogue]
  '("Dialogue" . screenwriter-dialog-block))
(define-key
  screenwriter-mode-map
  [menu-bar screenwriter action]
  '("Action" . screenwriter-action-block))
(define-key
  screenwriter-mode-map
  [menu-bar screenwriter slug]
